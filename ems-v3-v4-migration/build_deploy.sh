...
sam deploy --no-fail-on-empty-changeset --no-execute-changeset --template-file template.yaml --stack-name my-stack-name-$env --s3-bucket sam-temp-test-ems --capabilities CAPABILITY_IAM
